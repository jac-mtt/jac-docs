...
La Junta de Aeronáutica Civil pone a disposición la serie
de datos obtenidos de la bitácora de los aeropuertos de Chile,
correspondientes a los registros de arribo, despegue y
sobrevuelo que realizan las aeronaves en el país.

Estos datos son recolectados por la Dirección General de
Aeronáutica Civil (DGAC) en las torres de control operadas
por este organismo.
...
dashboard de [Operaciones de Naves en Aeropuertos/Aeródromos de Chile](https://app.powerbi.com/view?r=eyJrIjoiMjk4NDY4NDQtYTU1MC00MTNhLTk0MWQtYmY4ODcxMjhhMjhhIiwidCI6IjFhNmRiN2EwLTllZjgtNDQ1NC05MGUzLWMwNmM1Njc1N2FlZCIsImMiOjR9).

:::warning
No todas las operaciones de aeronaves que se efectuan en
...
que presenten alguna de las siguientes condiciones:
  ...
  - Provienen de aeródromos que no cuenten con administración
    de la DGAC.
:::
...
les asigna un código propio.
- `dt_operacion`: Adicional al periodo `t-1`, existen registros del primer
día del mes `t` para facilitar su uso en horario local (`America/Santiago`).
:::
