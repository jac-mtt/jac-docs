...
que se escogió este formato para la publicación de la bitácora de operaciones.
...
<Tabs>
  ...
  <TabItem value="powerbi" label="PowerBI">
    ...
    una ruta local. Para cargar el archivo desde la URL de publicación
    ...
    requerir más de un intento de carga.
    :::
