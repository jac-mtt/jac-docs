---
title: Bitácora y Dimensiones Aeronáuticas
sidebar_position: 2
---
...
compresión eficiente reduciendo el espacio de almacenamiento requerido. Es por estos motivos
...
utilizados directamente desde la URL de publicación. Más información [aquí](./descarga-datos.mdx).
...
<Tabs>
  ...
  <TabItem value="excel" label="Excel">
    ...
    - La última versión de [DuckDB](https://duckdb.org/docs/stable/guides/file_formats/excel_export.html)
      ...
      COPY (
          ...
          'C:\path\a\resultado\bitacora-vuelos.xlsx'
  ...
  <TabItem value="powerbi" label="PowerBI">
    ...
    el archivo a una ruta local, en este caso [desde el sitio web de Datos.Gob](docs/ejemplo-reuso-datos/descarga-datos.mdx#cómo-reutilizo-los-datos):
