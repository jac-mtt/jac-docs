...
# Datos de Operaciones Aeroportuarias

La Junta de Aeronáutica Civil carga en [Datos.Gob](https://datos.gob.cl/)
la serie de datos obtenidos de las bitácoras de los aeropuertos de Chile,
...
- `aerolinea_dgac`: Similar a lo anterior, no todas las
aerolíneas de Chile cuentan con un código OACI, por lo que la DGAC
